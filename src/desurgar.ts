...
export class Desurgar {
  ...
  desurgar(): void {
    this.visitNodes(this.program.sources);
  }
  ...
  _visitDeclarationStatement(node: DeclarationStatement): void {
    this.visitNode(node.name);
    this.visitNodes(node.decorators);
  }
  visitClassDeclaration(node: ClassDeclaration): void {
    this._visitDeclarationStatement(node);
  ...
  _visitVariableLikeDeclarationStatement(node: VariableLikeDeclarationStatement): void {
    this.visitNode(node.type);
    this.visitNode(node.initializer);
  }
  visitEnumValueDeclaration(node: EnumValueDeclaration): void {
    this._visitVariableLikeDeclarationStatement(node);
  }
